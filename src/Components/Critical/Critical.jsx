...
import settings from "./Images/ImageSettings.png";
        ...
        <div className={styles.threats}>
          ...
          <div className={styles.text}>
            ...
            <div>
              ...
              <span className={styles.redTxt}> {t("Infected")} </span>
              <span>{t("and Personal Data could be stolen!")}</span>
            </div>
          </div>
        </div>
